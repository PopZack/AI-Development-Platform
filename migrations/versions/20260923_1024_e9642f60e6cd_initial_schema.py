...
Revision ID: e9642f60e6cd
Revises: 
Create Date: 2026-09-23 10:24:35.577250
...
# ⚠️ Text 与 postgresql 是模型里 JSONB 变体带出来的依赖。
# autogenerate 会生成 `postgresql.JSONB(astext_type=Text())` 但**不会**导入 Text，
# 于是迁移执行到那一行才 NameError（表建到一半）。每次 autogenerate 后都要检查这里。
from sqlalchemy import Text
from sqlalchemy.dialects import postgresql

revision: str = 'e9642f60e6cd'
